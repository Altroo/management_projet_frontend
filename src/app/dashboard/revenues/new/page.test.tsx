...
describe('RevenueAddPage server component', () => {
	...
	it('renders RevenueFormClient with session and no id when session exists', async () => {
		const sessionValue: Session = { user: { pk: 9, email: 'manager@site.com' } };
