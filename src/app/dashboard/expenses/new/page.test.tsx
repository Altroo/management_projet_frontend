...
describe('ExpenseAddPage server component', () => {
	...
	it('renders ExpenseFormClient with session and no id when session exists', async () => {
		const sessionValue: Session = { user: { pk: 13, email: 'manager@site.com' } };
		...
		expect(decoded).toContain('"pk":13');
